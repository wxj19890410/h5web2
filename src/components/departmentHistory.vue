      ...
      <div style="width:100%;margin-left:0%;">
        <template >
          <el-table :data="tableData" stripe border :default-sort = "{prop: 'date', order: 'descending'}" >
            <el-table-column prop="name" label="子部门" sortable></el-table-column>
            <el-table-column prop="personNub" label="部门人数" sortable></el-table-column>
            <el-table-column prop="total"  label="部门总平均值" sortable></el-table-column>
